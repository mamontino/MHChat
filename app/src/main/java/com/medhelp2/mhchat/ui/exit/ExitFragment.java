...
public class ExitFragment extends BaseDialog implements ExitViewHelper
{
    public static final String TAG = "ExitFragment";
    public static final String EXTRA_ID = "EXTRA_ID";

    @Inject
    ExitPresenterHelper<ExitViewHelper> presenter;
    ...
    public static ExitFragment newInstance(int idDoctor)
    {
