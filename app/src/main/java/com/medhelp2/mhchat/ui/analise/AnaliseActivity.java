...
public class AnaliseActivity extends BaseActivity implements AnaliseViewHelper,
        NavigationView.OnNavigationItemSelectedListener
{
    @Inject
    AnaliseAdapter adapter;
    ...
    @BindView(R.id.rv_analise)
    RecyclerView recyclerView;

    @Inject
    AnalisePresenterHelper<AnaliseViewHelper> presenter;

    @BindView(R.id.toolbar_analise)
    Toolbar toolbar;
    ...
    @BindView(R.id.collapsing_toolbar_analise)
    CollapsingToolbarLayout toolbarLayout;

    @BindView(R.id.drawer_analise)
    DrawerLayout drawer;

    @BindView(R.id.fab_analise)
    FloatingActionButton fab;

    @BindView(R.id.nav_view_analise)
    ...
    {
        return new Intent(context, AnaliseActivity.class);
    }
