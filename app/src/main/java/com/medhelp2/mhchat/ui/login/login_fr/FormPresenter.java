...
public class FormPresenter<V extends FormViewHelper> extends BasePresenter<V> implements FormPresenterHelper<V>
{
    @Inject
    FormPresenter(DataHelper dataHelper,
